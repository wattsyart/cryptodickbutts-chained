...
public static class ParityErrorMessage
{
    public const string ErrorFetchingTokenUri = "Error fetching Token URI";
    public const string FailedToParseJsonCompare = "Failed to parse JSON compare";
    ...
    public const string ParityCheckCancelled = "Parity check was cancelled";
